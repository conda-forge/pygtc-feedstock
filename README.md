...
Once the `conda-forge` channel has been enabled, `pygtc` can be installed with:

```
conda install pygtc
```

It is possible to list all of the versions of `pygtc` available on your platform with:
